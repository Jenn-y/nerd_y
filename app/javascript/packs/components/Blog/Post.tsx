  ...
  return (
    <div className="col-lg-4 col-md-6 mb-2-6">
      <article className="card card-style2">
        ...
        <div id="custom-card-body">
          <div className="flex-container">
            <h3 className="card-title">{post.post.title}</h3>
            <button type="button" className={"btn btn-outline-" + (post.post.status === 'draft' ? "warning" : "success")}>{post.post.status}</button>
          </div>
